<template>
    <header class="header scroll-header">
        <nav class="nav container">
            <!-- logo -->
            <a href="#" class="nav__logo flex items-center gap-4">
                <!-- <img src="/public/img/icon.jpg" alt="logo" style="width: 50px; height: 50px; border-radius: 50%;"> -->
                <img src="/public/img/icon.jpg" alt="logo" style="width: 50px; height: 50px; border-radius: 50%;">
                sounfury
            ...
            <div class="nav__btns">
                <i :class="['alicon', theme === 'dark' ? 'alicon-taiyang' : 'alicon-moon', 'nav__theme']"
                    id="theme-button" @click="toggleTheme"></i>
